...
from utils import get_latest_data_filepath, today_date_string, shift_dstring, odds_calc, wager_calc, profit_calc
...
def eval_recent_performance(recent_days, adv_to_use):
    ...
    threshold = ADV_PCT_THRESHOLD if adv_to_use != 'adv' else ADV_THRESHOLD
